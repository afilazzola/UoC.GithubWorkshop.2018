...
Alternatively there are many ways to specify the `kable` function that can be found [here](https://haozhu233.github.io/kableExtra/awesome_table_in_html.html). 
